...
// Minimal icon set using SVG paths
...
const icons: Record<string, ReactElement> = {
  ...
  flask: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 3h6l3 8H6z"/><path d="M6 11v0c-1.4 1.2-2 2.8-2 4a6 6 0 0 0 12 0c0-1.2-.6-2.8-2-4"/>
...
export function QuestionIcon({ name, size = 24, className = "" }: QuestionIconProps) {
  const icon = icons[name] || icons.star;
  return (
    <span
      className={`inline-flex items-center justify-center text-gray-800 ${className}`}
